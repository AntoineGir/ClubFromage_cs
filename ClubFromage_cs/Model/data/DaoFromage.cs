...
namespace Model.data
{
    class DaoFromage
    {
       ...
       public void insertfil()
        ...
        {
            DataRow r = NewDbal.SelectByld("fromage", idFromage);
            Fromage fromage1 = new Fromage((int)r["id"], (int)r["pays_origine_id"], (string)r["nom"], (int)r["creation"], (string)r["image"]);
            Console.WriteLine(fromage1.Nom);
